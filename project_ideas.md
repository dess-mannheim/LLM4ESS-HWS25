...
- Pick 1 construct (and 2 associated datasets), 1 prompt variation, 1 persona variation, 1 other.
  - Constructs: sexism, populism, moral foundations, 
  - Prompt variations: CoT, definition, few-shot, counterfactual few-shot
  - Persona: with persona, without persona, with backstory
  - Other: system vs. user, temperature changes, 
...
For any of these projects, you are expected to pick 3-5 LLMs and compare their behavior. 

Exemplary Short Papers:
